...
public class Transform
{
    ...
    public Matrix4x4 ViewMatrix => Matrix4x4.Identity * Matrix4x4.CreateFromQuaternion(Rotation) * Matrix4x4.CreateScale(ScaleX, ScaleY, 1) * Matrix4x4.CreateTranslation(Position);
}